...
// ===========================================================================================
//   class DENG.CXHTML_H1
// ===========================================================================================

DENG.CXHTML_H1 = function() { super(); }

DENG.CXHTML_H1.prototype = new DENG.CWnd();

DENG.CXHTML_H1.prototype.initialize = function(node, parent)
{
	...
	_pta.fontsize = [{type:20, value:2}]; // 1.6em
