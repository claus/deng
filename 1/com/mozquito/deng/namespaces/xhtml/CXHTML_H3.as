...
// ===========================================================================================
//   class DENG.CXHTML_H3
// ===========================================================================================

DENG.CXHTML_H3 = function() { super(); }

DENG.CXHTML_H3.prototype = new DENG.CWnd();

DENG.CXHTML_H3.prototype.initialize = function(node, parent)
{
	...
	_pta.fontsize = [{type:20, value:1.5}]; // 1.5em
