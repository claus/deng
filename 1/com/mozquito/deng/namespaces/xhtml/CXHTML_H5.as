...
// ===========================================================================================
//   class DENG.CXHTML_H5
// ===========================================================================================

DENG.CXHTML_H5 = function() { super(); }

DENG.CXHTML_H5.prototype = new DENG.CWnd();

DENG.CXHTML_H5.prototype.initialize = function(node, parent)
{
	...
	_pta.fontsize = [{type:20, value:1.1}]; // 1.1em
