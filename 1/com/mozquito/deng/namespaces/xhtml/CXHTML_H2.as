...
// ===========================================================================================
//   class DENG.CXHTML_H2
// ===========================================================================================

DENG.CXHTML_H2 = function() { super(); }

DENG.CXHTML_H2.prototype = new DENG.CWnd();

DENG.CXHTML_H2.prototype.initialize = function(node, parent)
{
	...
	_pta.fontsize = [{type:20, value:1.75}]; // 1.75em
