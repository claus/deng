...
// ===========================================================================================
//   class DENG.CXForms_SECRET
// ===========================================================================================

DENG.CXForms_SECRET = function() { super(); }

DENG.CXForms_SECRET.extend(DENG.CXFormsControlWnd);

DENG.CXForms_SECRET.prototype.initialize = function(node, parent)
{
	// initialize element wrapper
	super.initialize(node, parent);
};

DENG.CXForms_SECRET.prototype.create = function()
{
	super.create();
...
DENG.CXForms_SECRET.prototype.setDefaultControlStyles = function(ctrlObj) 
{
...
DENG.CXForms_SECRET.prototype.size = function()
{
	super.size();
};

DENG.CXForms_SECRET.prototype.onChanged = function() 
{
